...
class PartitionManager():
    ...
    def fetch_label_dict(self):
        ...
        elif dataset_name in ['extrasensory', 'extrasensory_watch']:
            self.label_dict = {
                'label:SITTING': 0, 
                'label:FIX_walking': 1,
                'label:BICYCLING': 2,
