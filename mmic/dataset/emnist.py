...
def generate(dir_path,num_clients,num_classes,niid,balance,partition,alpha):
    ...
    trainset = torchvision.datasets.EMNIST(
        root=os.path.join(dir_path,'rawdata'),split="byclass", train=True, download=True, transform=transform)
    testset = torchvision.datasets.EMNIST(
        root=os.path.join(dir_path,'rawdata'),split="byclass", train=False, download=True, transform=transform)
