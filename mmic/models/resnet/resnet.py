...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, **kwargs):
        ...
        self.embed_dim = kwargs['embedding_dim']
        if kwargs['embedding_dim'] != 512:
            self.linear = nn.Linear(512, self.embed_dim)
        # self.bn2 = nn.BatchNorm1d(2048)
        self.class_fc_2 = nn.Linear(self.embed_dim, kwargs['num_classes'])  # 2048 --> 512
...
def resnet_50_client(pretrained=False, **kwargs):
