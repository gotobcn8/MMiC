...
class MCSoftContrastiveLoss(nn.Module):
    ...
    """
    def __init__(self, init_negative_scale = 15, init_shift=15,num_samples = 7,criterion__negative_sampling_ratio = -1,vib_beta = 0,reduction='sum'):
        super().__init__()
...
def batchwise_cdist(samples1, samples2, eps=1e-6):
    ...
    """
    #torch.Size([1024, 256])      torch.Size([1024, 2048])
